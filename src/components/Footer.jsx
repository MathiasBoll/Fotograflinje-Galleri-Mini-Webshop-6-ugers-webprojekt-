    ...
    <footer className="footer">
      <div className="footer-container">
        <div className="footer-section">
          <Link to="/">
            <img src="/images/BW-logo-png.png" alt="Media College Denmark" className="footer-logo" />
          </Link>
        ...
        <div className="footer-section">
          ...
          <div className="footer-social">
            <a 
              href="https://www.facebook.com/media.college.denmark/?locale=da_DK" 
              target="_blank" 
        ...
        <div className="footer-section">
          ...
          <ul className="footer-links">
            ...
            <li><Link to="/events">Events & Udstillinger</Link></li>
            <li><Link to="/kontakt">Kontakt os</Link></li>
            <li><Link to="/fotograf-print-viborg">Om vores prints</Link></li>
